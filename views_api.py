...
@cyberherd_extension_ext.get("/api/v1/targets")
...
@cyberherd_extension_ext.put("/api/v1/targets", status_code=HTTPStatus.OK)
...
@cyberherd_extension_ext.delete("/api/v1/targets", status_code=HTTPStatus.OK)
...
@cyberherd_extension_ext.delete(
